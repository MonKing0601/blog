...
class ShowController extends CommonController
{
    ...
    public function detail($id)
    {
        ...
        $val=ArticleModel::Article_OrderByClick();
        return view('show.detail', ['data' => $data, 'cate' => $cate, 'click' => $onclick, 'comments' => $comments,'val'=>$val]);
    }
    ...
    public function about()
    {
        ...
        return view('show.common.about',['val'=>$val]);
    }
    ...
    {        $val=ArticleModel::Article_OrderByClick();
        ...
        return view('show.common.contact',['val'=>$val]);
    }
     ...
     * 文章点击度排行的右侧页面
     */
    public function right_side_order()
{
    $val=ArticleModel::Article_OrderByClick();
    return $val;
}
