...
<form action="{{url('admin/article')}}" method="post">
    ...
    <table width="70%" border="0" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
        ...
        <tr>
            <td>编辑作者</td>
            <td><input type="text" name="art_editor"/></td>
        </tr>
        <tr>
            <td>关键词</td>
            <td><input type="text" name="art_tag"/></td>
        </tr>
        <tr>
            <td>文章描述</td>
            <td><input type="text" name="art_description"/></td>
        </tr>
        <tr>
            <td>缩略图</td>
        ...
        <tr style="width: 100%;height: 100px;">
            <td>图片展示</td>
            <td><img src="" alt="" id="thumb_img" style="max-height: 250px; max-width: 150px"></td>
        </tr>
        <tr>
            <td>文章内容</td>
            <td>
        ...
        <tr>
            <td></td>
            <td colspan="2"><input type="submit" value="发表分类"/></td>
        </tr>
    </table>
</form>
</body>
